...
interface CurvesValuesChangeListener {
    ...
    fun onReset(rgb: List<Point>, r: List<Point>, g: List<Point>, b: List<Point>)
    ...
    class Simple(
        ...
        override fun onReset(rgb: List<Point>, r: List<Point>, g: List<Point>, b: List<Point>) = onReset.invoke()
    }
    ...
    class Save(
        ...
        override fun onReset(rgb: List<Point>, r: List<Point>, g: List<Point>, b: List<Point>) {
            onReset.invoke()
