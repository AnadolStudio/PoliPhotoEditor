...
import art.intel.soft.utils.bitmaputils.getScaleRatioMax
...
private fun getSupportPair(
    ...
    val ratio: Float = getScaleRatioMax(widthInto, heightInto, widthOut, heightOut)
...
fun fitViewToEdge(
    ...
    val ratio = min(
            getScaleRatio(source.height.toFloat(), heightContainer.toFloat()),
            getScaleRatio(source.width.toFloat(), widthContainer.toFloat())
    )
