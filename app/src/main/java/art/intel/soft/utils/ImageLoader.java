...
public class ImageLoader {
    ...
    public static void loadImageWithoutCache(Context context, String path, int width, int height, ScaleType scaleType,
                                             IResourceReady<Bitmap> listener) {
        getBaseRequestBuilder(context, path, scaleType, true)
                .override(width, height)
                .into(createBitmapTarget(listener));
    }

    public static void loadImageWithoutCache(Context context, String path, int widthResize, int heightResize, IResourceReady<Bitmap> listener) {
        getBaseRequestBuilder(context, path, ScaleType.FIT_CENTER, true)
